...
namespace Manageme.Services.Shared
{
    public class ServiceResult
    {
        ...
        public static ServiceResult InvalidPassword(params string[] errors)
            => new ServiceResult()
            {
        ...
        public static ServiceResult<TData> InvalidPassword<TData>(params string[] errors) where TData : class
            => new ServiceResult<TData>()
            {
                StatusCode = (HttpStatusCode)HttpStatusCodeExtras.InvalidPassword,
                Errors = errors
